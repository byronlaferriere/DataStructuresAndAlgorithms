...
//we can use a hashtag combined with the include command, to access the library file reference point by using quotation marks
...
int main(int argc, char* argv[]) {
    ...
    case 2:
        ...
        break;
    default:
        csvPath = "workspace-cdt\Lab2-1\Debug\eBid_Monthly_Sales_Dec_2016.csv";
    }
